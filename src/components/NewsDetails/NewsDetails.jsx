...
const NewsDetails = () => {
    ...
    const detailsNews = newsDetails.find(newsDetail => newsDetail.id === params.id)
    ...
    return (
        <div className="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden">
            ...
            <div className="p-4">
                ...
                <Link to="/">
                    <button className="btn btn-error text-white flex items-center gap-2 text-sm font-medium transition mt-10">
